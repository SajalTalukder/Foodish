...
import { category, meals, searchMeal } from "../../Components/Helper/Request";
...
const CategoryPage = ({ name, categoryData, meals1 }: Props) => {
  let content;
  console.log(name, meals1);
        ...
        <div className="col-span-5  h-auto">
          ...
          <div className="w-[80%] mx-auto mt-20 mb-10">
            <div className="flex items-center space-x-2">
              <h1 className="mb-8 text-2xl font-bold uppercase">{name}</h1>
              <h1 className="mb-8">
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const meals1 = await searchMeal(name);
  return {
    props: {
      categoryData,
      name,
